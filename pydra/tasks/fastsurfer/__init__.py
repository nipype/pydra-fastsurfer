...
try:
    ...
    raise RuntimeError(
        "pydra-fastsurfer has not been properly installed, please run "
...
if "nipype" not in __version__:
    try:
        ...
        warn(
            ...
            "to generated the converted Nipype interfaces in pydra.tasks.fastsurfer.auto"
        )
    else:
